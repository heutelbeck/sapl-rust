...
pub(crate) fn non_eq(lhs: &Result<Val, String>, rhs: &Result<Val, String>) -> Result<Val, String> {
    ...
    match (lhs, rhs) {
        ...
        (_, Err(e)) => Err(e.clone()),
        (lhs, rhs) => Err(format!(
            "Type mismatch. Non equal operation expects comparable values, but got: {lhs:#?} and {rhs:#?}"
        )),
    }
}
...
mod tests {
    ...
    fn non_eq_boolean() {
        ...
        assert_eq!(Ok(Val::Boolean(false)), non_eq(&lhs, &rhs));

        let (lhs, rhs) = init(true, false);
        assert_eq!(Ok(Val::Boolean(true)), non_eq(&lhs, &rhs));
    ...
    #[test]
    fn non_eq_boolean_with_comp_integer() {
        fn init(lhs: bool, rhs: bool) -> (Result<Val, String>, Result<Val, String>) {
    ...
    #[test]
    fn non_eq_comp_integer_with_boolean() {
        fn init(lhs: bool, rhs: bool) -> (Result<Val, String>, Result<Val, String>) {
    ...
    #[test]
    fn non_eq_comp_integer_with_comp_integer() {
        fn init(lhs: bool, rhs: bool) -> (Result<Val, String>, Result<Val, String>) {
    ...
    #[test]
    fn non_eq_boolean_with_comp_float() {
        fn init(lhs: bool, rhs: bool) -> (Result<Val, String>, Result<Val, String>) {
    ...
    #[test]
    fn non_eq_comp_float_with_boolean() {
        fn init(lhs: bool, rhs: bool) -> (Result<Val, String>, Result<Val, String>) {
    ...
    #[test]
    fn non_eq_comp_float_with_comp_float() {
        fn init(lhs: bool, rhs: bool) -> (Result<Val, String>, Result<Val, String>) {
            (
    ...
    fn non_eq_lhs_error() {
        ...
        assert_eq!(Err("Fault lhs".to_string()), non_eq(&lhs, &rhs));
    }
    ...
    fn non_eq_rhs_error() {
        ...
        assert_eq!(Err("Fault rhs".to_string()), non_eq(&lhs, &rhs));
    }
    ...
    fn non_eq_error() {
        ...
        let err = Err(
            "Type mismatch. Non equal operation expects comparable values, but got: Ok(\n    String(\n        \"something\",\n    ),\n) and Ok(\n    Boolean(\n        true,\n    ),\n)".to_string(),
        );
        assert_eq!(err, non_eq(&lhs, &rhs));
    }
}
